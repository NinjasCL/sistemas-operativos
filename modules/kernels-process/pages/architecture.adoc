...
En esta actividad se practicará la creación de scripts con Bash.

- Realizar los ejercicios resueltos de la sección 2.30 del libro Enrique Soriano.

- Realizar los ejercicios no resueltos de la sección 2.31 del libro Enrique Soriano. Ejercicio 7 y Ejercicio 11.
